...
public class Quiz extends JFrame implements ActionListener{
	...
	Quiz(String name){
		...
		ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/quizfinal.jpg"));
		...
		questions[0][4]="Rasmun Lerdoef";
		
		questions[1][0]="Which of the following is not a valid C variable name?";
		questions[1][1]="int number;";
		questions[1][2]="float rate;";
		questions[1][3]="int variable_count;";
		questions[1][4]="int $main;";
		...
		questions[3][2]="Marker Interface";
		questions[3][3]="Abstract Interface";
		...
		questions[4][4]="Random storage space";
		
		questions[5][0]="Which keyword is used to prevent any changes in the variable within a C program?";
		questions[5][1]="Volatile";
		questions[5][2]="Const";
		questions[5][3]="Mutable";
		questions[5][4]="Immutable";
		...
		questions[9][1]="Bytecode is executed bt JVM";
		...
		answers[9][1]="Bytecode is executed bt JVM";
